...
import com.matthew.springbootmall.rowmapper.OrderItemRowMapper;
import com.matthew.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public Order getOrderById(Integer orderId) {
        String sql = "SELECT order_id, user_id, total_amount, created_date, last_modified_date FROM `order` WHERE `order`.order_id = :orderId";
        Map<String, Object> map = new HashMap<>();
